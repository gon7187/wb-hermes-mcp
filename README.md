...
Сервер предоставляет 56 инструментов основного seller-функционала:
...
Confirmation хранится только в памяти процесса, поэтому plan и apply должны
пройти через один живой экземпляр MCP; не сохраняйте ID для другого
stdio-процесса.
...
Полный список всех 56 инструментов и их режимов работы — в
[справочнике tools](docs/tools.md).
Миграция существующего Hermes описана в
[операционном runbook](docs/migration/runbook.md), а результаты теневой
проверки — в [validation log](docs/migration/validation.md).
